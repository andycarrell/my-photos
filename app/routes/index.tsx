      ...
      <div className="relative sm:pb-16 sm:pt-8">
          ...
          <div className="relative shadow-xl sm:overflow-hidden sm:rounded-2xl">
            ...
            <div className="lg:pb-18 relative px-4 pt-16 pb-8 sm:px-6 sm:pt-24 sm:pb-14 lg:px-8 lg:pt-32">
              <h1 className="text-center text-6xl font-extrabold tracking-tight sm:text-8xl lg:text-9xl">
                <div className="text-violet-500 drop-shadow-md">
                  GET MY PHOTOS
                </div>
              </h1>
              <p className="mx-auto mt-6 max-w-lg text-center text-xl text-white sm:max-w-3xl">
                Seamlessly access content you own. Instagram without the frills.
              </p>
                ...
                {user ? (
                  <div className="space-y-4 sm:mx-auto sm:inline-grid sm:grid-cols-2 sm:gap-5 sm:space-y-0">
                    <Form action="/logout" method="post" className="w-full">
                      <button
                        type="submit"
                        className="flex w-full items-center justify-center rounded-md border border-transparent bg-white px-4 py-3 text-base font-medium text-violet-700 shadow-sm hover:bg-violet-50 sm:px-8"
                      >
                        Logout
                      </button>
                    </Form>
        ...
        <div className="mx-auto max-w-7xl py-2 px-4 sm:px-6 lg:px-8">
          <div className="mt-6 flex flex-wrap justify-center gap-8">
            {[
              {
                src: "https://user-images.githubusercontent.com/22784983/189474833-2e8fed9d-888b-4168-8eb7-7b09639c361e.png",
                alt: "Instagram",
